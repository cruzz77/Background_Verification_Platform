    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="max-w-md w-full bg-white border border-slate-200 rounded p-8 shadow-premium">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <h2 className="text-xl font-bold text-slate-900 tracking-tight">Sign In to vShield</h2>
          <p className="text-xs text-slate-500 font-medium mt-1">Background Verification Portal</p>
        </div>
        ...
        <div className="text-center mt-6">
          <p className="text-xs text-slate-500 font-medium">
            ...
            <Link to="/register" className="text-slate-950 font-semibold underline">
              Create an account
            </Link>
          </p>
        </div>
